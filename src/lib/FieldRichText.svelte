...
<FieldStandard bind:id label='' {path} {conditional} {finalize} let:id let:onBlur let:setVal>
  <RichTextEditor {path} {label} {maxlength} {required} {configType} {templateProperties} {config} {helptext} {findByIdCache} {findByUrlCache} />
</FieldStandard>
